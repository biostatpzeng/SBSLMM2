...
#include "dtpr.hpp"
#include "sbslmmfit.hpp"

using namespace std;
using namespace arma;

int SBSLMMFIT::est(int n_ref, int n_obs, double sigma_s, int num_block, vector<int> idv, string bed_str,
...
int SBSLMMFIT::calcBlock(int n_ref, int n_obs, double sigma_s, vector<int> idv, string bed_str, 
...
vec SBSLMMFIT::PCGv(mat A, vec b, size_t maxiter, const double tol){
	vec dA = A.diag();
...
mat SBSLMMFIT::PCGm(mat A, mat B, size_t maxiter, const double tol){
...
int SBSLMMFIT::estBlock(int n_ref, int n_obs, double sigma_s, mat geno_s, mat geno_l, vec z_s, vec z_l, vec &beta_s, vec &beta_l) {
...
int SBSLMMFIT::estBlock(int n_ref, int n_obs, double sigma_s, mat geno_s, vec z_s, vec &beta_s) {
