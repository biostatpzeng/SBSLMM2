...
#SBATCH --array=1-2
#SBATCH --output=/net/mulan/disk2/yasheng/out/lassosums%a.out
#SBATCH --error=/net/mulan/disk2/yasheng/err/lassosums%a.err
...
for s in 1000 EUR; do
for cross in 1; do
let k=${k}+1
if [ ${k} -eq ${SLURM_ARRAY_TASK_ID} ]; then
ref=/net/mulan/disk2/yasheng/sample${s}/frq/merge
summ=/net/mulan/disk2/yasheng/pheno${PHENO}/summ/summary_cross${cross}
beta=/net/mulan/disk2/yasheng/sample${s}/lassosum/esteff_cross${cross}_chr
