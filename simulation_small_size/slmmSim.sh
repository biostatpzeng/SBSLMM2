...
slmmPheno=/net/mulan/home/yasheng/Biobank/code/simulation_bslmm/slmmPheno.R
...
Rscript ${slmmPheno} --path ${path} --block ${block} --herit ${herit} --cross ${cross} --type 0 --dist ${dist} \
--prop ${prop} --p ${ps}

## training and test set
bfile=/net/mulan/disk2/yasheng/simulation_bslmm/SLMM/data/geno_block${block}_her${herit}_cross${cross}_dist${dist}_ps${ps}_prop${prop}
bfiletr=/net/mulan/disk2/yasheng/simulation_bslmm/SLMM/data/train_block${block}_her${herit}_cross${cross}_dist${dist}_ps${ps}_prop${prop}
bfilete=/net/mulan/disk2/yasheng/simulation_bslmm/SLMM/data/test_block${block}_her${herit}_cross${cross}_dist${dist}_ps${ps}_prop${prop}
...
## reference data
bfileva=/net/mulan/disk2/yasheng/simulation_bslmm/SLMM/data/val_block${block}_her${herit}_cross${cross}_dist${dist}_ps${ps}_prop${prop}
...
summ=summary_block${block}_her${herit}_cross${cross}_dist${dist}_ps${ps}_prop${prop}
...
## PT 
summf=/net/mulan/disk2/yasheng/simulation_bslmm/SLMM/output/summary_block${block}_her${herit}_cross${cross}_dist${dist}_ps${ps}_prop${prop}
Rscript ${toplinkf} --gemma ${summf}.assoc.txt --plink ${summf}.plink.txt
clump1=/net/mulan/disk2/yasheng/simulation_bslmm/SLMM/PT/summary_block${block}_her${herit}_cross${cross}_dist${dist}_ps${ps}_prop${prop}
pred1=/net/mulan/disk2/yasheng/simulation_bslmm/SLMM/PT/pheno_block${block}_her${herit}_cross${cross}_dist${dist}_ps${ps}_prop${prop}
...
rm ${pred1}.log
rm ${pred1}.nopred
r21=/net/mulan/disk2/yasheng/simulation_bslmm/SLMM/PT/r2_block${block}_her${herit}_cross${cross}_dist${dist}_ps${ps}_prop${prop}
Rscript ${simpred} --pheno ${pred1}.profile --r2 ${r21}_p${p}.txt
rm ${pred1}.profile
done
pbestf1=/net/mulan/disk2/yasheng/simulation_bslmm/SLMM/PT/pbest1_block${block}_her${herit}_cross${cross}_dist${dist}_ps${ps}_prop${prop}
pbestf2=/net/mulan/disk2/yasheng/simulation_bslmm/SLMM/PT/pbest2_block${block}_her${herit}_cross${cross}_dist${dist}_ps${ps}_prop${prop}
...
## SBSLMM
fix=/net/mulan/disk2/yasheng/simulation_bslmm/SLMM/slmm/summary_fix_block${block}_her${herit}_cross${cross}_dist${dist}_ps${ps}_prop${prop}
ran=/net/mulan/disk2/yasheng/simulation_bslmm/SLMM/slmm/summary_ran_block${block}_her${herit}_cross${cross}_dist${dist}_ps${ps}_prop${prop}
Rscript ${clumpf2} --summ ${summf} --ref ${refld} --p 0.001 --max 1000 --effl ${fix} --effs ${ran}
snp=/net/mulan/disk2/yasheng/simulation2/LMM/slmm/eff_block${block}_her${herit}_cross${cross}_dist${dist}_ps${ps}_prop${prop}
${sbslmm} -s ${ran}.txt -l ${fix}.txt -r ${refld} -nsnp ${m} -n ${n} -b ${blockf} -h ${herit} \
-maxMaf 0.2 -t ${thread} -eff ${snp}
pred2=/net/mulan/disk2/yasheng/simulation_bslmm/SLMM/slmm/pheno_block${block}_her${herit}_cross${cross}_dist${dist}_ps${ps}_prop${prop}
...
snpeff1=snpeff_block${block}_her${herit}_cross${cross}_dist${dist}_ps${ps}_prop${prop}
${gemma} -bfile ${bfiletr} -bslmm 1 -o ${snpeff1} -w 6000 -s 2000 -rpace 1000
snpeff2=/net/mulan/disk2/yasheng/simulation_bslmm/SLMM/bslmm/output/snpeff_block${block}_her${herit}_cross${cross}_dist${dist}_ps${ps}_prop${prop}
snpeff3=/net/mulan/disk2/yasheng/simulation_bslmm/SLMM/bslmm/snpeff_block${block}_her${herit}_cross${cross}_dist${dist}_ps${ps}_prop${prop}
Rscript ${bslmmc} --bim ${bfiletr}.bim --eff ${snpeff2}.param.txt --effc ${snpeff3}.txt
predt=/net/mulan/disk2/yasheng/simulation_bslmm/SLMM/bslmm/pheno_block${block}_her${herit}_cross${cross}_dist${dist}_ps${ps}_prop${prop}
...
## lasso
esttr3=/net/mulan/disk2/yasheng/simulation_bslmm/SLMM/lasso/train_block${block}_her${herit}_cross${cross}_dist${dist}_ps${ps}_prop${prop}
plink-1.9 --bfile ${bfiletr} --lasso ${herit} --out ${esttr3}
predt=/net/mulan/disk2/yasheng/simulation_bslmm/SLMM/lasso/pheno_block${block}_her${herit}_cross${cross}_dist${dist}_ps${ps}_prop${prop}
...
est200=/net/mulan/disk2/yasheng/simulation_bslmm/SLMM/sblup/esteff_block${block}_her${herit}_cross${cross}_dist${dist}_ps${ps}_prop${prop}_200
est1000=/net/mulan/disk2/yasheng/simulation_bslmm/SLMM/sblup/esteff_block${block}_her${herit}_cross${cross}_dist${dist}_ps${ps}_prop${prop}_1000
...
pred3200=/net/mulan/disk2/yasheng/simulation_bslmm/SLMM/sblup/pheno_block${block}_her${herit}_cross${cross}_dist${dist}_ps${ps}_prop${prop}_200
pred31000=/net/mulan/disk2/yasheng/simulation_bslmm/SLMM/sblup/pheno_block${block}_her${herit}_cross${cross}_dist${dist}_ps${ps}_prop${prop}_1000
...
coord1=/net/mulan/disk2/yasheng/simulation_bslmm/SLMM/ldpred/summary_cv_block${block}_her${herit}_cross${cross}_dist${dist}_ps${ps}_prop${prop}.HDF5
${py} ${ldpred} coord --gf ${bfileva} --ssf ${summf}_LDpred.sumstat --out ${coord1} --N ${n} --ssf-format STANDARD --max-freq-discrep 0.2
ldest=/net/mulan/disk2/yasheng/simulation_bslmm/SLMM/ldpred/ld_block${block}_her${herit}_cross${cross}_dist${dist}_ps${ps}_prop${prop}
infest=/net/mulan/disk2/yasheng/simulation_bslmm/SLMM/ldpred/esteff_block${block}_her${herit}_cross${cross}_dist${dist}_ps${ps}_prop${prop}
${py} ${ldpred} gibbs --cf ${coord1} --ldr ${ldr} --ldf ${ldest} --out ${infest} --N ${n} --h2 ${herit} --f 1 0.3 0.1 0.03 0.01 0.003 0.001 0.0003 0.0001 

pred41=/net/mulan/disk2/yasheng/simulation_bslmm/SLMM/ldpred/pheno_block${block}_her${herit}_cross${cross}_dist${dist}_ps${ps}_prop${prop}
r24=/net/mulan/disk2/yasheng/simulation_bslmm/SLMM/ldpred/r2_block${block}_her${herit}_cross${cross}_dist${dist}_ps${ps}_prop${prop}
...
pbestf4=/net/mulan/disk2/yasheng/simulation_bslmm/SLMM/ldpred/r2_block${block}_her${herit}_cross${cross}_dist${dist}_ps${ps}_prop${prop}_best.txt
Rscript ${max2} --r2 ${r24}_p --pbest ${pbestf4} 
pbest4=`cat ${pbestf4}`
rm ${r24}_p*

coord2=/net/mulan/disk2/yasheng/simulation_bslmm/SLMM/ldpred/summary_ref_block${block}_her${herit}_cross${cross}_dist${dist}_ps${ps}_prop${prop}.HDF5
...
predInf4=/net/mulan/disk2/yasheng/simulation_bslmm/SLMM/ldpred/pheno_block${block}_her${herit}_cross${cross}_dist${dist}_ps${ps}_prop${prop}_inf
predp4=/net/mulan/disk2/yasheng/simulation_bslmm/SLMM/ldpred/pheno_block${block}_her${herit}_cross${cross}_dist${dist}_ps${ps}_prop${prop}_pbest
...
## lassosum
est5=/net/mulan/disk2/yasheng/simulation_bslmm/SLMM/lassosum/esteff_block${block}_her${herit}_cross${cross}_dist${dist}_ps${ps}_prop${prop}
Rscript ${lassosum} --summ ${summf}.assoc.txt --ref ${refld} --test ${bfileva} --beta ${est5}.txt
pred5=/net/mulan/disk2/yasheng/simulation_bslmm/SLMM/lassosum/pheno_block${block}_her${herit}_cross${cross}_dist${dist}_ps${ps}_prop${prop}
