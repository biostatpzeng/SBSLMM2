...
#SBATCH --output=/net/mulan/disk2/yasheng/out/simSLMM5_%a.out
#SBATCH --error=/net/mulan/disk2/yasheng/err/simSLMM5_%a.err
...
slmmPheno=/net/mulan/home/yasheng/Biobank/code/simulation/slmmPheno.R
...
bfile=/net/mulan/disk2/yasheng/simulation2/SLMM/data/geno_block${block}_her${herit}_cross${cross}_dist${dist}_ps${ps}_prop${prop}
bfiletr=/net/mulan/disk2/yasheng/simulation2/SLMM/data/train_block${block}_her${herit}_cross${cross}_dist${dist}_ps${ps}_prop${prop}
bfilete=/net/mulan/disk2/yasheng/simulation2/SLMM/data/test_block${block}_her${herit}_cross${cross}_dist${dist}_ps${ps}_prop${prop}
...
# # # ## reference data
bfileval=/net/mulan/disk2/yasheng/simulation2/SLMM/data/val_block${block}_her${herit}_cross${cross}_dist${dist}_ps${ps}_prop${prop}
...
## PT 
summf=/net/mulan/disk2/yasheng/simulation2/SLMM/output/summary_block${block}_her${herit}_cross${cross}_dist${dist}_ps${ps}_prop${prop}
Rscript ${toplinkf} --gemma ${summf}.assoc.txt --plink ${summf}.plink.txt
clump1=/net/mulan/disk2/yasheng/simulation2/SLMM/PT/summary_block${block}_her${herit}_cross${cross}_dist${dist}_ps${ps}_prop${prop}
pred1=/net/mulan/disk2/yasheng/simulation2/SLMM/PT/pheno_block${block}_her${herit}_cross${cross}_dist${dist}_ps${ps}_prop${prop}
...
## SLMM
fix=/net/mulan/disk2/yasheng/simulation2/SLMM/slmm/summary_fix_block${block}_her${herit}_cross${cross}_dist${dist}_ps${ps}_prop${prop}
ran=/net/mulan/disk2/yasheng/simulation2/SLMM/slmm/summary_ran_block${block}_her${herit}_cross${cross}_dist${dist}_ps${ps}_prop${prop}
Rscript ${clumpf2} --summ ${summf} --ref ${refld} --p 0.001 --max 100 --effl ${fix} --effs ${ran}
snp=/net/mulan/disk2/yasheng/simulation2/SLMM/slmm/eff_block${block}_her${herit}_cross${cross}_dist${dist}_ps${ps}_prop${prop}
${sbslmm} -s ${ran}.txt -l ${fix}.txt -r ${refld} -nsnp ${m} -n ${n} -b ${blockf} -h ${herit} \
-maxMaf 0.2 -t ${thread} -eff ${snp}
pred2=/net/mulan/disk2/yasheng/simulation2/SLMM/slmm/pheno_block${block}_her${herit}_cross${cross}_dist${dist}_ps${ps}_prop${prop}
...
est200=/net/mulan/disk2/yasheng/simulation2/SLMM/sblup/esteff_block${block}_her${herit}_cross${cross}_dist${dist}_ps${ps}_prop${prop}_200
est1000=/net/mulan/disk2/yasheng/simulation2/SLMM/sblup/esteff_block${block}_her${herit}_cross${cross}_dist${dist}_ps${ps}_prop${prop}_1000
...
pred3200=/net/mulan/disk2/yasheng/simulation2/SLMM/sblup/pheno_block${block}_her${herit}_cross${cross}_dist${dist}_ps${ps}_prop${prop}_200
pred31000=/net/mulan/disk2/yasheng/simulation2/SLMM/sblup/pheno_block${block}_her${herit}_cross${cross}_dist${dist}_ps${ps}_prop${prop}_1000
...
coord1=/net/mulan/disk2/yasheng/simulation2/SLMM/ldpred/summary_cv_block${block}_her${herit}_cross${cross}_dist${dist}_ps${ps}_prop${prop}.HDF5
${py} ${ldpred} coord --gf ${bfileval} --ssf ${summf}_LDpred.sumstat --out ${coord1} --N ${n} --ssf-format STANDARD --max-freq-discrep 0.2
ldest=/net/mulan/disk2/yasheng/simulation2/SLMM/ldpred/ld_block${block}_her${herit}_cross${cross}_dist${dist}_ps${ps}_prop${prop}
infest=/net/mulan/disk2/yasheng/simulation2/SLMM/ldpred/esteff_block${block}_her${herit}_cross${cross}_dist${dist}_ps${ps}_prop${prop}
${py} ${ldpred} gibbs --cf ${coord1} --ldr ${ldr} --ldf ${ldest} --out ${infest} --N ${n} --h2 ${herit} \
--f 1 0.3 0.1 0.03 0.01 0.003 0.001 0.0003 0.0001 

pred41=/net/mulan/disk2/yasheng/simulation2/SLMM/ldpred/pheno_block${block}_her${herit}_cross${cross}_dist${dist}_ps${ps}_prop${prop}
r24=/net/mulan/disk2/yasheng/simulation2/SLMM/ldpred/r2_block${block}_her${herit}_cross${cross}_dist${dist}_ps${ps}_prop${prop}
...
pbestf4=/net/mulan/disk2/yasheng/simulation2/SLMM/ldpred/r2_block${block}_her${herit}_cross${cross}_dist${dist}_ps${ps}_prop${prop}_best.txt
Rscript ${max2} --r2 ${r24}_p --pbest ${pbestf4} 
pbest4=`cat ${pbestf4}`

coord2=/net/mulan/disk2/yasheng/simulation2/SLMM/ldpred/summary_ref_block${block}_her${herit}_cross${cross}_dist${dist}_ps${ps}_prop${prop}.HDF5
...
predInf4=/net/mulan/disk2/yasheng/simulation2/SLMM/ldpred/pheno_block${block}_her${herit}_cross${cross}_dist${dist}_ps${ps}_prop${prop}_inf
predp4=/net/mulan/disk2/yasheng/simulation2/SLMM/ldpred/pheno_block${block}_her${herit}_cross${cross}_dist${dist}_ps${ps}_prop${prop}_pbest
...
## lassosum
est5=/net/mulan/disk2/yasheng/simulation2/SLMM/lassosum/esteff_block${block}_her${herit}_cross${cross}_dist${dist}_ps${ps}_prop${prop}
Rscript ${lassosum} --summ ${summf}.assoc.txt --ref ${refld} --test ${bfileval} --beta ${est5}.txt
pred5=/net/mulan/disk2/yasheng/simulation2/SLMM/lassosum/pheno_block${block}_her${herit}_cross${cross}_dist${dist}_ps${ps}_prop${prop}
